...
<body>
		...
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<ul class="dropdown-menu">
					...
					<li><a href="user.php"><?php echo $_SESSION['uname']; ?></a></li>
	...
	<!-- Slider Begins -->
	 ...
	 <div><img src="assets/images/car1.jpg"></div>
		...
		<div><img src="assets/images/car6.jpg"></div>
		<div><img src="assets/images/car7.jpg"></div>
		<div><img src="assets/images/car8.jpg"></div>
		<div><img src="assets/images/car5.jpg"></div>
		<div><img src="assets/images/car9.jpg"></div>
		<div><img src="assets/images/car10.jpg"></div>
		<div><img src="assets/images/car11.jpg"></div>
  	</div>
		...
		<div class="row">
			...
			<div class="col-md-8">
				...
				<div class="panel panel-info">
					...
					<div class="panel-footer">&copy; Vijay Jonathan K (cse17031)</div>
				</div>
			</div>
			<div class="col-md-1"></div>
		</div>
